...
{
  new (message_memory) robot_interfaces::msg::ArmState(_init);
}

void ArmState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::ArmState *>(message_memory);
  typed_message->~ArmState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmState_message_member_array[1] = {
  {
    ...
    offsetof(robot_interfaces::msg::ArmState, end_effector_pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArmState_message_members = {
  ...
  1,  // number of fields
  sizeof(robot_interfaces::msg::ArmState),
...
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, ArmState)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmState_message_type_support_handle;
}
