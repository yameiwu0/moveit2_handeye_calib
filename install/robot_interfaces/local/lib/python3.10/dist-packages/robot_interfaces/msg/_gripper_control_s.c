...
bool robot_interfaces__msg__gripper_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._gripper_control.GripperControl", full_classname_dest, 52) == 0);
  }
  robot_interfaces__msg__GripperControl * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of GripperControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._gripper_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GripperControl");
