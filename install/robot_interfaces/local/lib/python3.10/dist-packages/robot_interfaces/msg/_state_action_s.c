...
bool robot_interfaces__msg__state_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._state_action.StateAction", full_classname_dest, 46) == 0);
  }
  robot_interfaces__msg__StateAction * ros_message = _ros_message;
  {  // state_name
...
{
  /* NOTE(esteve): Call constructor of StateAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._state_action");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateAction");
