...
# ros2 topic pub --once /qt_cmd robot_interfaces/msg/QtRecv "{working_mode: 9, joint_angles_goal: {layout: {dim: [], data_offset: 0}, data: [0, 0, 0, 0, 0, 0]}, arm_pose_goal: {position: {x: 0.0, y: 0.0, z: 0.0}, orientation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}}"
