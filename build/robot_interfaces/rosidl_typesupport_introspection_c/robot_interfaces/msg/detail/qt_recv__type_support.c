...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__msg__QtRecv__rosidl_typesupport_introspection_c__QtRecv_message_member_array[4] = {
  {
    "working_mode",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__msg__QtRecv, gripper_goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_interfaces, msg, QtRecv)() {
  ...
  robot_interfaces__msg__QtRecv__rosidl_typesupport_introspection_c__QtRecv_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Float64MultiArray)();
  robot_interfaces__msg__QtRecv__rosidl_typesupport_introspection_c__QtRecv_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Float64MultiArray)();
