...
class ArmState(metaclass=Metaclass_ArmState):
    ...
    _fields_and_field_types = {
        'end_effector_pose': 'geometry_msgs/Pose',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Pose
        self.end_effector_pose = kwargs.get('end_effector_pose', Pose())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.end_effector_pose != other.end_effector_pose:
            return False
        return True
    ...
    def end_effector_pose(self):
        """Message field 'end_effector_pose'."""
        return self._end_effector_pose

    @end_effector_pose.setter
    def end_effector_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'end_effector_pose' field must be a sub message of type 'Pose'"
        self._end_effector_pose = value
