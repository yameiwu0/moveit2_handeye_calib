...
#include "robot_interfaces/msg/detail/arm_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // end_effector_pose
...
using _ArmState__ros_msg_type = robot_interfaces__msg__ArmState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: end_effector_pose
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->end_effector_pose, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_robot_interfaces__msg__ArmState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArmState__ros_msg_type * ros_message = static_cast<const _ArmState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ArmState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__ArmState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__ArmState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__ArmState;
    is_plain =
      (
...
static size_t _ArmState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__ArmState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, ArmState)() {
