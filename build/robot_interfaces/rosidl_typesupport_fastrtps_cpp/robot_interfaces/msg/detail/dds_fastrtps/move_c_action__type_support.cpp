...
#include "robot_interfaces/msg/detail/move_c_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::MoveCAction & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose_array
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.pose_array,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::MoveCAction & ros_message)
{
  // Member: pose_array
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_interfaces
max_serialized_size_MoveCAction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::MoveCAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::MoveCAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::MoveCAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoveCAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::MoveCAction *>(
...
static size_t _MoveCAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoveCAction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoveCAction__callbacks = {
...
static rosidl_message_type_support_t _MoveCAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveCAction__callbacks,
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_MoveCAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, MoveCAction)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_MoveCAction__handle;
}
