...
robot_interfaces__msg__RobotControlMsg__init(robot_interfaces__msg__RobotControlMsg * msg)
{
  ...
  // kp
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->kp, 0)) {
    robot_interfaces__msg__RobotControlMsg__fini(msg);
    return false;
  }
  // kd
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->kd, 0)) {
    robot_interfaces__msg__RobotControlMsg__fini(msg);
    return false;
  }
  return true;
...
robot_interfaces__msg__RobotControlMsg__fini(robot_interfaces__msg__RobotControlMsg * msg)
{
  ...
  // kp
  rosidl_runtime_c__uint8__Sequence__fini(&msg->kp);
  // kd
  rosidl_runtime_c__uint8__Sequence__fini(&msg->kd);
}
