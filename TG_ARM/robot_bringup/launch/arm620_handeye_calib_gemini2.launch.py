...
def generate_launch_description():
    ...
    default_rviz_config = os.path.join(
        ...
        'rviz', 'arm620_handeye_calib_gemini2.rviz'
    )
    ...
    # 将 gemini2 的 camera_link 连接到机械臂 Link6
    # 注意: gemini2 相机的坐标系名称可能是 camera_link 或 camera_frame
    camera_mount_tf = Node(
        ...
        arguments=[
            ...
            "--yaw", "0.0",
            "--frame-id", "Link6",
            "--child-frame-id", "camera_link",  # gemini2 的 camera_link
        ],
    )
